...
dam_square = Landmark.create!(
  ...
  address: "Dam",
  country: "the Netherlands",
  image: "https://fthmb.tqn.com/4DfXYVqN_NMWeLtt_L50533NEFk=/960x0/filters:no_upscale()/GettyImages-590593755-591243a25f9b5864700d3fd0.jpg"
  )
...
fashion_tour = Story.create!(
  ...
  image: "http://2.bp.blogspot.com/-X3ct7WegdbY/VOSO2oJD8PI/AAAAAAAAAZo/v5bCxX0Vn84/s1600/KLPAhOj8xEbpS.gif",
  mp3:"Bijenkorf.mp3",
  description: "All about me. I will go shopping in the Jordaan and you can listen",
  language: "English",
  category: "Shopping",
  lat: 52.3739,
  lng: 4.8809
