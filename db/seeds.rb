...
film_location_tour = Story.create!(
  ...
  image: "http://2.bp.blogspot.com/-X3ct7WegdbY/VOSO2oJD8PI/AAAAAAAAAZo/v5bCxX0Vn84/s1600/KLPAhOj8xEbpS.gif",
...
cooking_tour = Story.create!(
  ...
  landmark: jordaan,
  title: "Famous film locations in Amsterdam",
  image: "https://dwjt-dontworryjusttra.netdna-ssl.com/wp-content/uploads/2015/03/Discover-17-Netherlands-food-specialties-in-Amsterdam_febo-Netherlands-fast-food.jpg",
  mp3:"../app/assets/audio/Bijenkorf.mp3",
  description: "Walk the streets and learn all about where to find the best meat and cheese in Amsterdam. Delicous!",
  language: "English",
  category: "Food",
  lat: 52.3739,
  lng: 4.8809
...
weed_stories = Story.create!(
  ...
  title: "Weed stories",
  image: "http://mmjreporter.com/wp-content/uploads/2017/10/Coffee-Shops-in-Amsterdam.jpg",
  mp3:"../app/assets/audio/Bijenkorf.mp3",
...
fashion_tour = Story.create!(
  ...
  image: "http://2.bp.blogspot.com/-X3ct7WegdbY/VOSO2oJD8PI/AAAAAAAAAZo/v5bCxX0Vn84/s1600/KLPAhOj8xEbpS.gif",
  mp3:"../app/assets/audio/Bijenkorf.mp3",
  description: "https://www.iamsterdam.com/media/locations-ndtrc/shopping/v-c-openinghours-marie-charlotte-peze.jpg",
  language: "English",
  category: "Shopping",
  lat: 52.3739,
  lng: 4.8809
...
film_stories = Story.create!(
  ...
  image: "https://willmsworks.net/en/wp-content/uploads/2013/09/In-the-Movies_Beitrag.jpg",
  mp3:"../app/assets/audio/Bijenkorf.mp3",
