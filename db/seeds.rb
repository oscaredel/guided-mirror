...
cooking_tour = Story.create!(
  ...
  mp3:"../app/assets/audio/Bijenkorf.mp3",
  description: "Walk the streets and learn all about where to find the best meat and cheese in Amsterdam. Delicious!",
  language: "English",
  category: "Food",
  lat: 52.3739,
  lng: 4.8809
...
fashion_tour = Story.create!(
  ...
  image: "https://www.iamsterdam.com/media/locations-ndtrc/shopping/v-c-openinghours-marie-charlotte-peze.jpg",
  mp3:"../app/assets/audio/Bijenkorf.mp3",
